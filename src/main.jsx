...
function QuickReplyModal({phone,onClose}){
 ...
 const[listStatuses,setListStatuses]=useState(()=>['Pronto','Para fotografar','Anúncio preparado','Anunciado']);
 ...
 const saleReadyStatuses=['Pronto','Para fotografar','Anúncio preparado','Anunciado'];
 ...
 return <Modal className="v10527-quick-reply-modal v10538-quick-reply-modal" title="Resposta rápida" subtitle={phoneDisplayName(phone,{includeCode:false})} titleIcon={<MessageSquare size={18}/>} onClose={onClose}>
  ...
  <div className="v10527-reply-footer"><small>Nenhuma mensagem é enviada automaticamente. O botão apenas copia o texto para você colar no WhatsApp, Marketplace ou onde preferir.</small><button type="button" onClick={onClose}>Fechar</button></div>
 </Modal>
}
