...
function GlobalInlineSelectLayer(){
 ...
 const closeMenu=()=>setMenu(current=>{try{current?.target?.classList?.remove('global-inline-select-open')}catch{}return null});
 useEffect(()=>{
  const open=event=>{
