 ...
 return <Modal className="batch-phone-modal" title="Cadastro em massa de aparelhos" onClose={onClose}>
  ...
  <section className="batch-shared-section">
   <header className="batch-shared-header">
    ...
    <label className="batch-inline-toggle"><input type="checkbox" checked={!!shared.splitTotal} onChange={e=>setSharedField('splitTotal',e.target.checked)}/><span><b>Dividir valor total da compra</b><small>Opcional. Mantém o valor individual quando estiver desligado.</small></span></label>
