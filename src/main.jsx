...
function Parts(){
  ...
  const auxiliaryPartsOverlayOpen=showRules||quoteModal||!!directBuy||!!orderEditor||!!refundEditor||!!standaloneReturnEditor;
  useEffect(()=>{
...
const BACKUP_REQUIRED_KEYS=[SKEY,ADSNOTEKEY,VKEY,BKEY,FKEY,QKEY,OKEY,RKEY,UKEY,PKEY,TKEY,IKEY,MKEY,MENUKEY,CFGKEY,ATITLEKEY,ADESCKEY,VIEWKEY,CHECKKEY,GOALKEY,PHONECOLKEY,TABLELAYOUTKEY,STATUSKEY,FONT_SCALE_KEY];
...
function materializeBackupSchema(storage){
 const defaults={
  [SKEY]:[],[ADSNOTEKEY]:'',[VKEY]:[],[BKEY]:[],[FKEY]:[],[QKEY]:{},[OKEY]:[],[RKEY]:[],[UKEY]:[],[PKEY]:[],[TKEY]:[],[IKEY]:[],[MKEY]:[],
