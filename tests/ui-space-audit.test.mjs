...
const finalCss=fs.readFileSync(new URL('../src/v10481.css',import.meta.url),'utf8');

assert.match(main,/import'\.\/v10480\.css';import'\.\/v10481\.css';/,'v10481.css deve ser a última camada visual');
assert.match(main,/const APP_VERSION='10\.4\.81'/,'versão 10.4.80 não encontrada');
...
assert.ok(finalCss.includes('.v102-device-row>.v102-row-actions'),'v10481 deve posicionar ações explicitamente no mobile');
