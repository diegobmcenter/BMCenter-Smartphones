...
const finalCss=fs.readFileSync(new URL('../src/v10478.css',import.meta.url),'utf8');

assert.match(main,/import'\.\/v10477\.css';import'\.\/v10478\.css';/,'v10478.css deve ser a última camada visual');
assert.match(main,/const APP_VERSION='10\.4\.78'/,'versão 10.4.78 não encontrada');
assert.ok(finalCss.includes('.v102-route .v10313-main-toolbar'),'camada final deve compactar toolbar de Smartphones');
