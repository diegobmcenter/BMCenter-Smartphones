...
assert.match(main,/const APP_VERSION='10\.4\.77'/,'versão 10.4.77 não encontrada');
assert.doesNotMatch(main,/className=\"phone-detail-progress\"/,'etapas Comprado/Diagnóstico/Cotação/Pedido/Reparo/Anúncios/Venda foram removidas na v10.4.77');
