...
assert.match(main,/import'\.\/v10476\.css';/,'CSS v10.4.76 precisa ser carregado por último');
...
assert.match(main,/const APP_VERSION='10\.4\.76'/,'versão 10.4.76 não encontrada');
