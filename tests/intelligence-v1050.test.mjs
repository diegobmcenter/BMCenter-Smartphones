...
const sold={id:'s1',brand:'Samsung',model:'S23',date:'2026-07-01',paid:1000,otherCosts:50,parts:[{id:'part1',effectiveCost:100}],status:'Vendido',sale:{soldAt:'2026-07-11',value:1700,marketplaceFee:50,shippingCost:50}};
...
const sold2={...sold,id:'s2',date:'2026-07-05',paid:900,parts:[{effectiveCost:150}],otherCosts:0,sale:{soldAt:'2026-07-25',value:1650,marketplaceFee:0,shippingCost:50}};
