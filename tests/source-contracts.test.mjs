...
assert.match(main,/Peças BMCenter e itens avulsos no mesmo fornecedor/);
...
assert.match(parts,/itens avulsos do mesmo fornecedor, sem misturar custos/);
...
assert.match(parts,/Peças BMCenter e itens avulsos no mesmo fornecedor/);
assert.match(parts,/Avulso/);
